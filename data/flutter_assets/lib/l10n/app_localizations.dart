...
abstract class AppLocalizations {
  ...
  /// No description provided for @clipartCategoryPersonalized.
  ///
  /// In en, this message translates to:
  /// **'Personalized'**
  String get clipartCategoryPersonalized;

  /// No description provided for @clipartCategoryFaces.
  ///
  /// In en, this message translates to:
  /// **'Faces & Hands'**
  String get clipartCategoryFaces;

  /// No description provided for @clipartCategoryHeartsStars.
  ///
  /// In en, this message translates to:
  /// **'Hearts & Stars'**
  String get clipartCategoryHeartsStars;

  /// No description provided for @clipartCategoryArrows.
  ///
  /// In en, this message translates to:
  /// **'Arrows'**
  String get clipartCategoryArrows;

  /// No description provided for @clipartCategoryMediaTime.
  ///
  /// In en, this message translates to:
  /// **'Media & Time'**
  String get clipartCategoryMediaTime;

  /// No description provided for @clipartCategoryNatureWeather.
  ///
  /// In en, this message translates to:
  /// **'Nature & Weather'**
  String get clipartCategoryNatureWeather;

  /// No description provided for @clipartCategorySymbolsShapes.
  ///
  /// In en, this message translates to:
  /// **'Symbols & Shapes'**
  String get clipartCategorySymbolsShapes;

  /// No description provided for @clipartCategoryObjectsRetro.
  ///
  /// In en, this message translates to:
  /// **'Objects & Retro'**
  String get clipartCategoryObjectsRetro;
}
